...
import EnrichmentProgress from '@/app/components/EnrichmentProgress'

// ---------------------------------------------------------------------------
// HomePage — Phase 3
//
// Supersedes the Phase 2 version. The key change: the post-confirmation
// placeholder is replaced with <EnrichmentProgress />, which streams
// POST /api/enrich via ReadableStream and navigates to /run/[runId]/score
// on completion.
//
// State machine:
//   idle       → user sees UploadForm
//   confirmed  → EnrichmentProgress mounts and begins streaming
//   (complete) → router.push('/run/<runId>/score') — page unmounts
//
